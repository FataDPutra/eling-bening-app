                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-green-100 text-sm">
                            <li className="flex items-start gap-3">
                                ...
                                <span>{content.address || "Jl. Sarjono, Bauman, Ambarawa, Kabupaten Semarang, Jawa Tengah."}</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Phone size={18} className="flex-shrink-0" />
                                <span>{content.phone || "+62 811-2345-6789"}</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail size={18} className="flex-shrink-0" />
                                <span>{content.email || "info@elingbening.com"}</span>
                            </li>
                        </ul>
                    </div>
