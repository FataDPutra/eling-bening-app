        ...
        <div className="animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div className="flex-1">
                    <h1 className="text-2xl md:text-3xl font-black text-admin-text-main tracking-tight uppercase">Pemasukan Resort</h1>
                    <p className="text-xs md:text-sm text-admin-text-muted font-bold">Laporan pendapatan dari penyewaan kamar dan fasilitas resort.</p>
                </div>
