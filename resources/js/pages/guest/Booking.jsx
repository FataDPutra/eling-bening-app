        ...
        <main className="pt-24 pb-20 px-6 max-w-6xl mx-auto animate-fade-in bg-gray-50 min-h-screen relative z-0">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <div className="space-y-10">
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {['Kamar Bebas Rokok', 'Lantai Atas', 'Ranjang Besar (Large)', 'Ranjang Twin (Sepisah)'].map((facility, idx) => (
                                        <label key={idx} className="flex items-center gap-4 cursor-pointer p-5 border border-gray-100 rounded-2xl hover:bg-green-50/50 hover:border-eling-green/20 transition-all group">
                                            <input 
                                                type="checkbox" 
                                            ...
                                            />
                                            <span className="text-sm font-black text-gray-600 group-hover:text-gray-900">{facility}</span>
                                        </label>
                                    ))}
                                </div>
                            </div>
                ...
                <div className="lg:col-span-4 relative z-0">
                    <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/50 border border-gray-100 overflow-hidden sticky top-28">
                        ...
                        <div className="p-10">
                            ...
                            <div className="flex flex-col items-center gap-1 mt-10 opacity-40">
                                ...
                                <p className="text-[8px] font-bold text-gray-400">© 2026 ELING BENING APP. ALL RIGHTS RESERVED.</p>
                            </div>
                        </div>
                    </div>
                </div>
