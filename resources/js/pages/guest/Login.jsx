...
export default function Login() {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            let message = 'Terjadi kesalahan saat login. Silakan coba lagi nanti.';
            
            if (error.response?.status === 422 || error.response?.status === 401) {
                message = 'Email atau password yang Anda masukkan salah. Silakan periksa kembali detail login Anda.';
    ...
    return (
        <div className="min-h-screen flex text-gray-900 bg-gray-50">
            ...
            <div className="hidden lg:flex w-1/2 bg-gray-900 relative">
                <img src="/images/generated/hero.png" className="w-full h-full object-cover opacity-60" alt="Login bg" />
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white relative">
                ...
                <div className="w-full max-w-md">
                    ...
                    >
                        ...
                        <span className="text-gray-600">Lanjutkan dengan Google</span>
                    </button>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div className="relative">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <Link to="/forgot-password" disabled className="text-sm font-medium text-eling-green hover:text-green-800 transition">Lupa password?</Link>
                            </div>
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
