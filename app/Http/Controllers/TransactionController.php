    ...
    public function store(Request $request)
    {
        ...
        return DB::transaction(function() use ($request, $validated) {
            ...
            $transaction = Transaction::create([
                ...
                'net_total' => in_array($validated['booking_type'], ['RESORT', 'TICKET', 'EVENT']) ? ($validated['total_price'] - round($validated['total_price'] * (10 / 110))) : $validated['total_price'],
                'tax_total' => in_array($validated['booking_type'], ['RESORT', 'TICKET', 'EVENT']) ? round($validated['total_price'] * (10 / 110)) : 0,
